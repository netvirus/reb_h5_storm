 ...
 *
 */
public class CommunityBoardCharacterItems implements ScriptFile, ICommunityBoardHandler
{
	private static final Logger _log = LoggerFactory.getLogger(CommunityBoardCharacterItems.class);
	...
	public static final CommunityBoardCharacterItems getInstance()
	{
	...
	{
		protected static final CommunityBoardCharacterItems _instance = new CommunityBoardCharacterItems();
	}
