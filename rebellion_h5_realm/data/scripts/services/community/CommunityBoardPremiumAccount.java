    ...
    public String getAction(Player player, String bypass) {
        ...
        if (bypass.startsWith("list")) {
            ...
            if (premium != null)
            {
                ...
                if ((player.hasTwoPremium()) || (!premium.isBonusMain() && hasHourBonus)) {
                    html = HtmCache.getInstance().getNotNull(Config.BBS_HOME_DIR + "pages/premium/allreadyhaveall.htm", player);
                }
