...
public class PathfinderInstance extends NpcInstance
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		{
			if(getNpcId() == 32484 && Config.ALT_KAMALOKA_NIGHTMARES_PREMIUM_ONLY && !player.getPlayerAnyActivePremiumType())
			{
		...
		else if(command.startsWith("solo_kamaloka"))
		{
			...
			{
				ReflectionManager.enterReflection(player, new KamalokaNightmare(player), val);
			}
		}
		else
	...
	{
		int bonusExpire = player.getClient().getBonusExpire();
