...
public class SystemMessage extends L2GameServerPacket
{
	...
	public static final int SUB_KEY_CAN_BE_CTRL_ALT_SHIFT_AND_YOU_MAY_ENTER_TWO_SUB_KEYS_AT_A_TIME___N_EXAMPLE__CTRL___ALT__ = 2112; // Вспомогательными клавишами могут быть CTRL, ALT, SHIl2r. Вы можете нажимать две одновременно. Например, "CTRL + ALT + A"
	...
	public static final int IS_OUT_OF_PROPER_CALCULATION_RANGE = 3093;
	...
	{
		return new SystemMessage(SystemMessage.YOU_HAVE_ACQUIRED_S2_S1).addItemName(item.getdisplayId() > 0 ? item.getdisplayId() : item.getItemId()).addNumber(item.getCount());
	}	
